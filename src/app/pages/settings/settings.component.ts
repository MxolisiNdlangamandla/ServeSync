    ...
    return [
      {
        ...
        name: 'Starter',
        price: 'Free',
        badge: tier === 'tier1' ? 'Current' : rank > this.planRank('tier1') ? 'Included' : 'Available now',
      ...
      },
      {
        ...
        name: 'Essentials',
        price: 'R259 / month',
        badge: tier === 'tier2' ? 'Current' : rank > this.planRank('tier2') ? 'Included' : 'Available now',
      ...
      },
      {
        ...
        name: 'Professional',
        price: 'R499 / month',
        badge: tier === 'tier3' ? 'Current' : rank > this.planRank('tier3') ? 'Included' : 'Available now',
